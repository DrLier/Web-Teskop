    ...
    <div class="max-w-screen-xl px-4 pt-20 mx-auto lg:pt-24 lg:px-6 items-center text-start place-items-center">
        <div id="animation-carousel" class="relative w-full" data-carousel="static">
            ...
            <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                ...
                <!-- Item 2 -->
                <div class="hidden duration-200 ease-linear" data-carousel-item>
                    <img src="../public/images/kopi-2.png"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <!-- Item 3 -->
                <div class="hidden duration-200 ease-linear" data-carousel-item="active">
                    <img src="../public/images/kopi-3.png"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <!-- Item 4 -->
                <div class="hidden duration-200 ease-linear" data-carousel-item>
                    <img src="../public/images/kopi-4.png"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <!-- Item 5 -->
                <div class="hidden duration-200 ease-linear" data-carousel-item>
                    <img src="../public/images/kopi-5.png"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
            </div>
            <!-- Slider controls -->
...
<section>
    <p class="max-w-screen-xl px-6 mx-auto lg:pt-12 items-center text-start place-items-center text-xl font-bold">Pilihan
        Cafe Kami</p>
    <div
        ...
        <?php foreach ($coffees as $coffee) { ?>
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                ...
                <div class="px-5 pb-5">
                    ...
                    <a href="#">
                        <h5 class="text-base font-normal tracking-tight text-gray-900">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="https://api.whatsapp.com/send/?phone=6281313136057&text=Kak%2C+aku+mau+pesen+menu+ini+%3A%0A"
