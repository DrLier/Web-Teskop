...
<footer class="bg-white">
    ...
    <div class="text-center py-8 bg-black">
        ...
        <div class="flex gap-4 justify-center">
            <p class="pb-3 block text-sm text-center text-gray-500"><i class="pr-2 fa-solid fa-phone"></i><a href="tel:081313136057" class="hover:underline">+62 813-1313-6057</a></p>
            <p class="pb-3 block text-sm text-center text-gray-500"><i class="pr-2 fa-solid fa-envelope"></i><a href="mailto:teskop@gmail.com? &subject=Pemesanan Menu ITTS Coffee &body=Kak, aku mau pesan menu berikut :" class="hover:underline">teskop@gmail.com</a></p>

        </div>
        <span class="block text-sm text-center text-gray-500">©Teskop - <a href="https://lms.telkomuniversity.ac.id/course/view.php?id=44479" class="hover:underline">PemWeb</a> Big Project
            Created by <a href="https://docs.google.com/spreadsheets/d/1CNT2ZUat-ekkWAfEUeM9g0MXHP0WzvXBuiMmFbw_6QE/edit#gid=2109082417" class="hover:underline">9th Teams</a>.
        </span>
